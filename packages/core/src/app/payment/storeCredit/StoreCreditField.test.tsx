...
describe('StoreCreditField', () => {
  ...
  it('renders form field with available loan amount as label', () => {
    render(
    ...
    expect(screen.getByText(/loan amount to order/)).toBeInTheDocument();
  });
  ...
  it('renders field input as checkbox', () => {
    ...
    expect(
      screen.getByRole('checkbox', { name: 'Apply $112.00 loan amount to order' }),
    ).toBeInTheDocument();
  });
